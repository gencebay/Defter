        ...
        case ParseState.comment:
          {
            ...
            if (
              (noClosingSymbolAsteriskPrereq || asterisk.length > 0) &&
              this.eat("/")
            ) {
            ...
            if (this.peek() === "*") {
              ...
              if (
                this.eatWord(JSDOC_DEFAULTVALUE) ||
                this.eatWord(JSDOC_DEFAULT)
              ) {
        ...
        case ParseState.declaration:
          {
            ...
            if (isOptional) {
              identifierName = identifierName.substr(
                0,
                identifierName.length - 1
              );
            }
