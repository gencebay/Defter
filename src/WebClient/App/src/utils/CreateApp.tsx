...
import { App, IAppDefinition, IAppLink } from "../App";
import {
  Router,
  Route
} from "office-ui-fabric-react/lib/utilities/router/index";
...
export function createApp(
  ...
  function _onLoad(): void {
    ...
    let routes: (JSX.Element | JSX.Element[])[] = groups.map(
      (group: ExampleGroup, groupIndex: number) =>
        ...
        <Fabric>
          <Router>
            ...
            <Route
              key={"app"}
              component={(props: {}) => (
                <App appDefinition={appDefinition} {...props} />
              )}
            >
              {routes}
            </Route>
...
function _getComponent<TProps extends React.Props<{}>>(
  props: TProps
): JSX.Element {
  return <div {...props} />;
}
